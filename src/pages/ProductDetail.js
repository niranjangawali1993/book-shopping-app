...
import { getProductDetailsById } from '../services';
...
export const ProductDetail = () => {
  ...
  useEffect(() => {
    const cartProduct = cartList.find((cartProd) => cartProd.id === product.id);
    if (cartProduct) setInCart(true);
      ...
      <section>
        ...
        <div className='flex flex-wrap justify-around'>
          <div className='max-w-xl my-3'>
            <img className='rounded' src={product?.image_local} alt='Product' />
          </div>
          <div className='max-w-xl my-3'>
